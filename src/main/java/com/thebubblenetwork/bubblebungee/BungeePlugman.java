...
public class BungeePlugman implements Plugman<Plugin>{
    private PluginManager pluginManager;
    private ProxyServer server;

    public BungeePlugman(ProxyServer server) {
        this.server = server;
    ...
    public Plugin load(File file) {
        if(file.isFile() && file.getName().endsWith(".jar")) {
            ...
            try {
                ...
                try {
                    ...
                    if(x2 == null)throw new IllegalArgumentException("Doesn't contain plugin.yml or bungee.yml!");
        ...
        else throw new IllegalArgumentException("Must be a jar file");
    }
